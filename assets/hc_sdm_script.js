...
class HC_CD{
    constructor(){
        this.hp_cd = '';
        this.p_cd = '<html><head></head><body><div class="hc_cd hc_cd_p" data-deadline="" data-end-action="0" data-flip="0" id="hc_cd_p44"><div><p class="hc_cd_heading h2">Sale ends in:</p><p class="hc_cd_subheading">Free 2-Day Shipping</p></div><div class="hc_cd-timer timer_2"><div class="hc_cd_timercard"><span class="hc_cd_timernum hc_cd_days">00</span><div class="hc_cd_timerlabel hc_cd_label_days">Days</div></div><div class="hc_cd_timercard"><span class="hc_cd_timernum hc_cd_hours">00</span><div class="hc_cd_timerlabel hc_cd_label_hours">Hours</div></div><div class="hc_cd_timercard"><span class="hc_cd_timernum hc_cd_minutes">00</span><div class="hc_cd_timerlabel hc_cd_label_minutes">Mins</div></div><div class="hc_cd_timercard"><span class="hc_cd_timernum hc_cd_seconds">00</span><div class="hc_cd_timerlabel hc_cd_label_seconds">Secs</div></div></div></div></body></html>';
        this.pp_selector = ".product-section > div > div:nth-child(1) > div > div:nth-child(2) > div > div:nth-child(2) > div.product-block.buy-width > div";
        this.pp_position = 1;
        this.pp_use_campaign_dates = true;
        this.pp_valid_till = "";
    }
